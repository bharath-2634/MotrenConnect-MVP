  ...
  return (
    <div className="w-full mt-10 flex flex-col items-center justify-center p-6 font-poppins">
      <div className="flex flex-col items-center justify-center gap-3">
        <h1 className="text-[2.5rem] font-medium text-white">Developer Forum</h1>
        <p className="text-[1.2rem] font-semibold text-[#ccc] mt-2">
          Join Motren Dev-forum , Build Projects - Make Impact - Earn Rewards
        </p>
      </div>
      {/* developer - 1 */}
        ...
        >
          <div className="relative w-[260px] h-[240px] flex items-center justify-center">
            {devCards.map((card, index) => (
              <motion.div
                key={index}
                className="absolute bg-[#1a1a1a] text-white px-3 py-3 rounded shadow flex items-center gap-3 w-56"
                custom={index}
                initial="initial"
