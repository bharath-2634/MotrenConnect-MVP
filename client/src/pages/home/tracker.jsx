          ...
          {project.map((pro, idx) => (
            <SwiperSlide key={pro._id}>
              <div className={`rounded-2xl shadow-lg p-6 flex flex-col items-center justify-center h-full text-center transition duration-300 ease-in-out ${bgColors[idx % bgColors.length]}`}>
                ...
                <p className='text-start w-full p-3 text-gray-600 text-[.8rem] h-[40%] overflow-clip'>is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
